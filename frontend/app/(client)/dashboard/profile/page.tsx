...
// Matches the real backend's userUpdateSchema exactly — firstName/
// lastName/phone/avatarUrl. There is no `email` (email changes need a
// separate verified flow, not implemented on the backend) or `bio` field
// on the User model at all.
